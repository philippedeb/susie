      ...
      <Container className="d-flex flex-column justify-content-center align-items-center my-5">
        ...
        <div className="d-flex align-items-center">
          <Form className="d-flex">
            ...
            >
              <FormControl type="text" placeholder="Paste GitHub URL here" className="rounded-pill bg-white text-dark border-0 shadow-sm w-100 mr-2" style={{ maxWidth: '90%', minWidth: '400px', borderColor: '#757167', borderWidth: 'medium' }} />
            </OverlayTrigger>
            <OverlayTrigger
              placement="bottom"
              overlay={<Tooltip>Analyze</Tooltip>}
            >
              <Button variant="secondary" className="rounded-pill" style={{ backgroundColor: '#757167', marginLeft: '10px' }}>
